            ...
            <div class="row">
                ...
                <div class="col-md-8 col-sm-7 col-xs-12 form-ct">
                    ...
                    <div class="form-main">
                        ...
                        <form class="form-customer form-login" method="post" action="{{ route('client.reset_password') }}" onsubmit="">
                            {{ csrf_field() }}

                            <div class="form-group name contact">
                                <label>Email<span>*</span></label>
                                <input name="email" type="email" class="form-control form-account" placeholder="Registered Email" required>
                            </div>
