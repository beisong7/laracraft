                        ...
                        <form action="{{ route('blog.update', $blog->id) }}" class="form-horizontal" role="form" enctype="multipart/form-data" method="post">
                            ...
                            <fieldset>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        <input class="" type="file" name="banner" accept="image/*" onchange="shwimg($(this))" id="imgInp">
                                    </div>
                                </div >
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <div class="text-center" style="max-height: 400px; padding: 0; border-radius: 5px; margin: 0 auto; background: #a7a7a7">
                                            <img id="imgtoshow"  src="{{ url($blog->banner) }}" class="img-fit-h single_img" style="width: 100%; max-height: 100%;" alt="">
                                        </div>
                                    </div>
