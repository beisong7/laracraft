            ...
            <div class="col-12 mb-4">
                <div class="card border-left-primary shadow h-100 py-2">
                    <div class="card-body">
                        ...
                        <hr>
                        <form method="POST" action="{{ route('slider.update', $slider->uuid) }}" aria-label="{{ __('new-slider') }}" enctype="multipart/form-data">
                            @csrf
                                    ...
                                    <div class="row">
                                        @if(!empty($slider->upload))
                                            <div class="col-sm-6 col-md-3">
                                                ...
                                                <a href="{{ route("upload-delete", $slider->upload->uuid) }}" class=" btn btn-block btn-outline-danger ">Remove <i class="fa fa-trash"></i></a>
                                            </div>
                                        @else
                                            <div class="col-sm-6 col-md-3">
                                                <h5>No Image</h5>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            ...
                                            <select name="is_url" id="" class="form-control">
                                                <option value="no" {{ !$slider->is_url?'selected':'' }} >No</option>
                                                <option value="yes" {{ $slider->is_url?'selected':'' }} >Yes</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input type="text" autocomplete="off" name="slider_url" value="{{ $slider->slider_url  }}" class="form-control" placeholder="Example: http://{{ env('SITE_DOMAIN','') }}/products">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input type="text" autocomplete="off" name="button_url" value="{{ $slider->button_url }}" class="form-control" placeholder="Example: http://{{ env('SITE_DOMAIN') }}/products">
                                </div>
                            </div>
...
@section('other_js')
    ...
    <script type="text/javascript">
        ...
        let md = new Dropzone("#dropzone", {
            url: '{{ route('uploadSlider', !empty($slider->uuid)?$slider->uuid:old('uuid')) }}',
            maxFilesize: 1,
            ...
            removedfile: function(file) {
                ...
                $.ajax({
                    ...
                    type: 'POST',
                    url: '{{ route("sliderDelete", !empty($slider->uuid)?$slider->uuid:old('uuid')) }}',
                    data: {filename: name},
