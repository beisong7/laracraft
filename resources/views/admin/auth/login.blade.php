                ...
                <div class="card-body p-0">
                    ...
                    <div class="p-5">
                        <div class="text-center">
                            ...
                            <p class="text-center">Admin | {{ env('APP_NAME', '') }}</p>
                        </div>
                        <form class="user" method="post" action="{{ route('cms.login') }}">
                            {{ csrf_field() }}
                            <br>
                        ...
                        <br>
                        <div class="text-center">
                            <a class="small" href="{{ route('cms_reset_password') }}">Forgot Password?</a>
                        </div>
